...
path = "/home/deepmeta/detectron2/data_scoreboard/"
file_list_txt = []
file_list_jpg = []
jsonString = '{"images":['
i = 0
...
#                 print(y2)
                ...
                annotations = annotations + str(x1) + '.0,' + str(y1) + '.0,' + str(x2) + '.0,' + str(y2) + '.0],"category_id":' + str(classid+1) + ',"id":' + str(y+1) +',"iscrowd": 0'+ '},'
                y = y + 1
...
text = open('/home/deepmeta/detectron2/data_scoreboard/result.json', 'w')
