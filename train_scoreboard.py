...
register_coco_instances("baseball_scoreboard", {}, "./data_scoreboard/result.json", "./data_scoreboard/")
...
cfg.DATASETS.TRAIN = ("baseball_scoreboard",)
cfg.DATASETS.TEST = ()  
...
cfg.OUTPUT_DIR = cfg.OUTPUT_DIR+'_scoreboard'
cfg.SOLVER.MAX_ITER = (
    10000
